 ...
 *
 */
public class GildorymDonatorClaimLevelsEvent extends GildorymDonatorEvent implements Cancellable {
	...
	public GildorymDonatorClaimLevelsEvent(final Player donator, int levels) {
		super(donator);
		this.levels = levels;
	}
